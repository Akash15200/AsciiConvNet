...
# MNIST dataset
train_dataset = AsciiConvNetDataset('dataset/extract/', train=True, transforms=transforms.ToTensor())
test_dataset = AsciiConvNetDataset('dataset/extract/', train=False, transforms=transforms.ToTensor())
...
model = AsciiConvNet(num_classes) # .to(device)
