...
float static_buffer[375856];
float* dynamic_buffer = nullptr;

int meta_buf_0[] = {365180,367880,900,3,3,900};
int meta_buf_1[] = {367880,290300,1,3,30,30,32,32,3,3,1,1,1,1,2,2};
int meta_buf_2[] = {290300,0,317948,1024,16,27};
int meta_buf_3[] = {432,317948,334332,16,16,16,1024};
int meta_buf_4[] = {334332,361084,1,32,32,16,16,16,2,2,2,2,0,0};
int meta_buf_5[] = {361084,243644,1,16,16,16,18,18,3,3,1,1,1,1,2,2};
int meta_buf_6[] = {243644,448,350716,324,32,144};
int meta_buf_7[] = {5056,350716,350716,32,32,32,324};
int meta_buf_8[] = {350716,370580,1,18,18,32,9,9,2,2,2,2,0,0};
int meta_buf_9[] = {370580,373172,32,81,81,32};
int meta_buf_10[] = {373172,5088,375764,1,92,2592};
int meta_buf_11[] = {243552,375764,375764,92};
...
extern "C" void init() {
    //static_buffer = (float*)malloc(375856 * sizeof(float));
}
...
maxpooling2d_386ebef75ea973afd833e12e5ea8f6c97456944cd3812afb94b9bb4e(meta_buf_8);
transpose_3ede431373fd6b14a21ca5a7f2fab289eb4c42220e346f22acc816e8(meta_buf_9);
tensordot_b0c87b9ad9c24d5c638538a68fd9e1ad2b472c70c0e98883fad5c6af(meta_buf_10);
elementwiseadd_98450d361d3b8b06ad718e1e961bda61506f2baab3157c18aecbf897(meta_buf_11);
